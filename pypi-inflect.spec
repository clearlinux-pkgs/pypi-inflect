...
Source0  : https://files.pythonhosted.org/packages/78/c6/943357d44a21fd995723d07ccaddd78023eace03c1846049a2645d4324a3/inflect-7.5.0.tar.gz
...
%prep
%setup -q -n inflect-7.5.0
cd %{_builddir}/inflect-7.5.0
pushd ..
cp -a inflect-7.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735439123
