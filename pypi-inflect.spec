...
Source0  : https://files.pythonhosted.org/packages/a8/da/0d51c307544f4cde8d5aeadc2ff6b4d51f8fcd768467f62013b16a8002b5/inflect-5.3.0.tar.gz
...
%prep
%setup -q -n inflect-5.3.0
cd %{_builddir}/inflect-5.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638483378
...
cp %{_builddir}/inflect-5.3.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-inflect/8e6689d37f82d5617b7f7f7232c94024d41066d1
